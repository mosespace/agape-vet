          ...
          <ul
            className={`${
              menuOpen
                ...
                : "hidden lg:flex lg:flex-row lg:items-center dark:lg:text-slate-950 lg:text-slate-50 "
            }lg:flex lg:items-center lg:flex-row gap-[3rem] font-medium dark:lg:text-slate-950 text-slate-50 w-full left-0 md:w-auto px-[3rem] transition-all ease-in-out duration-500`}
          >
